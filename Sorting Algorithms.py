...
Original file is located at
    https://colab.research.google.com/drive/1r_OL0igoR7KU0ULE6y1q1tL3Z9e4AaMZ
"""
...
def insertion_sort(unsorted):
  ...
  return sorted, comparisons, num_swaps

a, comparisons, swaps = insertion_sort(unsorted)
...
def partition (seq):
  ...
  for a in range(0, len(seq)): 
    if seq[a] < pivot:
      ...
      high.append(seq[a])
      comparisons += 1
  return low, pivot, high, comparisons
